              ...
              try {
                ...
                if (updateError) {
                  ...
                  toast.show({
                    ...
                    message: value
                      ? "Your account has been upgraded to Business. You can now create posts and manage companies."
                      : "Your account has been changed to Personal.",
                  });
                }
              } catch (e) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (queryError) {
        ...
        console.log(
          "Existing user_type values:",
          existingProfiles?.map((p) => p.user_type)
        );
      }
