    ...
    openGlobalSheet({
      ...
      children: (
        <ScrollView contentContainerStyle={{ padding: 24 }} showsVerticalScrollIndicator={false}>
          <ThemedText style={{ fontSize: 20, fontWeight: 'bold', textAlign: 'center', marginBottom: 16 }}>
            Customize Options
          </ThemedText>
          {/* Search Input */}
          <View style={{
          ...
          {filteredOptions.map((option) => {
            ...
            return (
              <TouchableOpacity
                ...
                disabled={!canToggle}
              >
                <Feather name={option.icon as any} size={20} color={badgeText} style={{ marginRight: 12 }} />
