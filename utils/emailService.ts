...
export const prepareApplicationAttachments = async (
  ...
  try {
    ...
    if (applicationData.documents && applicationData.documents.length > 0) {
      console.log(
        `Found ${applicationData.documents.length} documents to process`
      );
            ...
            if (docResponse.ok) {
              ...
              const attachment = {
                filename:
                  doc.name ||
                  `${doc.type}_${
                    applicationData.profiles?.username || "applicant"
                  }.pdf`,
              ...
              console.error(
                `Failed to fetch document ${doc.name}:`,
                docResponse.status
              );
            }
          } catch (error) {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Dear HR Team,</p>
          <p>A new application has been submitted for the <strong>${
            job.title
          }</strong> position.</p>
        </div>
        ...
        <div class="applicant-info">
          ...
          ${
            applicant.experience_years
              ? `<p><strong>Experience:</strong> ${applicant.experience_years} years</p>`
              : ""
          }
          ${
            applicant.education
          ...
          ${
            applicant.website
              ? `<p><strong>Website:</strong> <a href="${applicant.website}">${applicant.website}</a></p>`
              : ""
          }
          ${
        ...
        <div class="job-info">
          ...
          ${
            job.content
              ? `<p><strong>Job Description:</strong> ${job.content}</p>`
              : ""
          }
          ${
            job.criteria
        ...
        <div class="company-info">
          ...
          ${
            companies.description
              ? `<p><strong>Description:</strong> ${companies.description}</p>`
              : ""
          }
          ${
            companies.industry
          ...
          ${
            companies.size
              ? `<p><strong>Company Size:</strong> ${companies.size}</p>`
              : ""
          }
          ${
            companies.location
              ? `<p><strong>Location:</strong> ${companies.location}</p>`
              : ""
          }
          ${
            companies.website
              ? `<p><strong>Website:</strong> <a href="${companies.website}">${companies.website}</a></p>`
              : ""
          }
          ${
            companies.founded_year
              ? `<p><strong>Founded:</strong> ${companies.founded_year}</p>`
              : ""
          }
        </div>
        `
        ...
        <div class="documents-info">
          <h3>Cover Letter</h3>
          ${
            applicationData.cover_letter.startsWith("http")
